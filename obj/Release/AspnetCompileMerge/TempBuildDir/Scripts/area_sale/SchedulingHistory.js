function changeStatus(id, status, note,moretime) {
    ...
    .done(function (data) {
        if (data != null) {
            // alertPopup("Thông báo", "Duyệt thành công", "success");
...
.done(function (data) {
    if (data != null) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            $("#status_plustime_" + data[i].BedId).data('id', data[i].Id).data('room-id', data[i].BedId);
    ...
    $('.status_plustime').click(function () {
        ...
        if (id == undefined || id == null || id == "") {
            ...
            if (person == null || person == "") {
                ...
                changeStatus(id, "inprogress", "", person);
            }
