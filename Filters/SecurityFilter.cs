...
namespace Erp.BackOffice.Filters
{
    ...
    public class SecurityFilter : ActionFilterAttribute
    {
            ...
            if (sActionName != "login".ToLower() && sActionName != "logoff" && sActionName != "forgetpassword")
            {
                ...
                else
                {
                    if (filterContext.IsChildAction || filterContext.HttpContext.Request.IsAjaxRequest())
                        ...
                        filterContext.Result = new RedirectToRouteResult(new RouteValueDictionary { { "controller", "User" }, { "action", "Login" }, { "area", "" } });
                }
            }
        }
        [OutputCache(CacheProfile = "Cache24h", VaryByParam = "*", Location = OutputCacheLocation.Client)]
        ...
        {
            if(Helpers.Common.CurrentUser.UserTypeCode == "Admin")
            {
                return true;
            }
            else
        ...
        //public static bool IsDrugStore()
        //{
        //    if (Helpers.Common.CurrentUser.UserTypeCode == "NT")
        //    {
        //        return true;
        //    }
        //    else
        ...
        //    }
        //}
        //public static bool IsAdminDrugStore()
        //{
        //    if (Helpers.Common.CurrentUser.UserTypeCode == "ADS")
        //    {
        //        return true;
        //    }
        //    else
        ...
        //    }
        //}
        //public static bool IsStaffDrugStore()
        //{
        //    if (Helpers.Common.CurrentUser.UserTypeCode == "SDS")
        //    {
        //        return true;
        //    }
        //    else
        ...
        {
            if (Helpers.Common.CurrentUser.UserTypeCode == "KT")
            {
                return true;
            }
            else
        ...
        //public static bool IsAdminSystemManager()
        //{
        //    if (Helpers.Common.CurrentUser.UserTypeCode == "ASM")
        //    {
        //        return true;
        //    }
        //    else
        ...
        //    }
        //}
        //public static bool IsTrinhDuocVien()
        //{
        //    if (Helpers.Common.CurrentUser.UserTypeCode == "TDV")
        //    {
        //        return true;
        //    }
        //    else
        ...
        //    }
        //}
        public static bool IsQLKhoTong()
        {
            if (Helpers.Common.CurrentUser.UserTypeCode == "WT")
            {
                return true;
            }
            else
