...
namespace Erp.BackOffice.Account.Models
{
    public class CustomerViewModel
    {
        ...
        public DateTime? ModifiedIsLock { get; set; }
        public long LeadId { get; set; }
        public bool? isLead { get; set; }
    }
    public class TransferCustomerViewModel
    {
        public int? CustomerID { get; set; }
        public int? NguoiLapIdNew { get; set; }
        public string NameForBrand { get; set; }
        

    }
    public class KhachHangTheoThuViewModel
    {
    ...
    public class KhachhenModel
    {
        public string TITLE { get; set; }
        public int? ID { get; set; }
        public DateTime? UF_CRM_1542960755869 { get; set; }
        public string ADDRESS { get; set; }
        public List<PHONE> PHONE { get; set; }
        public int? HasCreate { get; set; } //1 là da tao
    }
    public class PHONE
    {
        public int ID { get; set; }
    ...
    {
        public List<KhachhenModel> result { get; set; }
