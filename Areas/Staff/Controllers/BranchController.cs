...
namespace Erp.BackOffice.Staff.Controllers
{
    ...
    public class BranchController : Controller
    {
        ...
        public ActionResult CreateLocation(string Id, string ParentId, string Group)
        {
            ...
            {
                model = SqlHelper.QuerySP<LocationViewModel>("spGetAll_Province", new
                {
                   // pMA_DVIQLY = Helpers.Common.CurrentUser.MA_DVIQLY,
                    Group = Group,
                    Id = Id
                }).FirstOrDefault();
        ...
        {
            var aa = Domain.Helper.SqlHelper.ExecuteSP("spDeleteLocation", new
            {
                //pMA_DVIQLY = Helpers.Common.CurrentUser.MA_DVIQLY,
                Group = group,
                Id = id
