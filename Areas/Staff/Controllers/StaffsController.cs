...
namespace Erp.BackOffice.Staff.Controllers
{
    ...
    public class StaffsController : Controller
    {
        ...
        public JsonResult GetListJsonStaffs(string Name)
        {
            ...
            var pathimg = Helpers.Common.GetSetting("Staffs");
            foreach (var item in list)
            {
                item.ProfileImage = Erp.BackOffice.Helpers.Common.KiemTraTonTaiHinhAnhHoapd(item.ProfileImage, "Staffs", "user",pathimg);
            };
