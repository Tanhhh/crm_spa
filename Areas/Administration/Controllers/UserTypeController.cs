        ...
        public ActionResult EditUserType(EditUserTypeModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                if (Request["Submit"]=="Save")
                {
                    ...
                    //ghi log 
                    Erp.BackOffice.Controllers.HomeController.WriteLog(model.Id, model.Name, "đã cập nhật loại người dùng", "UserType/EditUserType?AreaName=Administration&userTypeId=" + model.Id, Helpers.Common.CurrentUser.BranchId.Value);
        ...
        public ActionResult AddUserType(EditUserTypeModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                if (Request["Submit"]=="Save")
                {
                    ...
                    //ghi log 
                    Erp.BackOffice.Controllers.HomeController.WriteLog(userType.Id, model.Name, "đã tạo loại người dùng", "UserType/EditUserType?AreaName=Administration&userTypeId=" + userType.Id, Helpers.Common.CurrentUser.BranchId.Value);
