...
namespace Erp.BackOffice.Administration.Controllers
{
    ...
    public class AccessRightController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            TempData["AccessRight_Model"] = model;
        ...
        [HttpPost]
        public ActionResult Save(string userTypePage, bool isDelete)
        {
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.Snapshot }))
            {
                try
                {
                    ...
                    if(isDelete == true)
                    {
                        _userTypePageRepository.Delete(userTypePageModel.UserTypeId, userTypePageModel.PageId);
                    }
                    else
                    {
                        _userTypePageRepository.Insert(userTypePageModel);
