...
namespace Erp.BackOffice.Administration
{
    public class AdministrationAreaRegistration : AreaRegistration
    {
        ...
        private static void RegisterAutoMapperMap()
        {
            ...
            AutoMapper.Mapper.CreateMap<Domain.Entities.UserHistory, UserHistoryViewModel>();
            AutoMapper.Mapper.CreateMap<UserHistoryViewModel, Domain.Entities.UserHistory>();
