...
namespace Erp.BackOffice.Crm.Controllers
{
    ...
    public class CampaignController : Controller
    {
        ...
        #region Khang - Show History
        public ViewResult ShowHistory()
        {
            return View();
        }
        public PartialViewResult GetHistoryList(string StartDate,string EndDate, string nameFilter)
        {
            var q = SqlHelper.QuerySP<CampaignHistoryViewModel>("spCrm_LeadLog_CampaignHistory",
                new
                {
                    @pStartDate = StartDate,
                    @pEndDate = EndDate,
                    @pnameFilter = nameFilter
                }).ToList();
            return PartialView("HistoryTable",q);
        }
        #endregion
    }
}
