...
{
    public class ChiSoNhanVienViewModel
    {
        ...
        public decimal SLLenCu { get; set; }
        public decimal SLMuaCu { get; set; }
        public decimal SLLenMoi { get; set; }
        public decimal SLMuaMoi { get; set; }
        public decimal SLHenCu { get; set; }
        public decimal DSAoOrlaneMoi { get; set; }
        public decimal DSThucOrlaneMoi { get; set; }
        public decimal DSAoOrlaneCu { get; set; }
        public decimal DSThucOrlaneCu { get; set; }

        public decimal TongOrlane { get; set; }
        public decimal DSAoAnnayake { get; set; }
        public decimal DSThucAnnayake { get; set; }
        public decimal DSAoLeonorGreyl { get; set; }
        public decimal DSThucLeonorGreyl { get; set; }
        public decimal TBDSOrlaneAoMoi { get; set; }
        public decimal TBDSOrlaneThucMoi { get; set; }
        public decimal TBDSOrlaneAoCu { get; set; }
        public decimal TBDSOrlaneThucCu { get; set; }
        public string NguonKhach { get; set; }
        public string tenNguonKhach { get; set; }
        public decimal TongAoOrlane { get; set; }
        public decimal TongThucOrlaneNVKD { get; set; }
    }
    public class ChiSoNhanVienTheoNguonKhachViewModel
    {
        public int? SLTuongTacMoi { get; set; }
        public int? SLTuongTacCu { get; set; }
        public int? SLKhachMoiHen { get; set; }
        public int? SLLenMoi { get; set; }
        public int? SLMuaMoi { get; set; }
        public decimal? TyLeMuaLenMoi { get; set; }
        public decimal? DSAoMoi { get; set; }
        public decimal? DSThucMoi { get; set; }
        public decimal? TBDSThucMoi { get; set; }
        public decimal? TBDSThucAOMoi { get; set; }
    }
    public class ChiSoKhachHangTuongTac
    {
        public int? TTmoi { get; set; }
        public int? TTcu { get; set; }
        public int? HenMoi { get; set; }
    }
}