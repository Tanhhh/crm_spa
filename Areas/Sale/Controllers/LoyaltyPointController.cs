    ...
    public class LoyaltyPointController : Controller
    {
        ...
        public ActionResult Create(LoyaltyPointViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //ghi log 
                Erp.BackOffice.Controllers.HomeController.WriteLog(LoyaltyPoint.Id, model.Name, "đã tạo điểm tích lũy", "LoyaltyPoint/Index", Helpers.Common.CurrentUser.BranchId.Value);
        ...
        public ActionResult Edit(LoyaltyPointViewModel model)
        {
            if (ModelState.IsValid)
            {
                if (Request["Submit"] == "Save")
                {
                    ...
                    //ghi log 
                    Erp.BackOffice.Controllers.HomeController.WriteLog(LoyaltyPoint.Id, model.Name, "đã cập nhật điểm tích lũy", "LoyaltyPoint/Index", Helpers.Common.CurrentUser.BranchId.Value);
