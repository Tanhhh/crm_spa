    ...
    public class SupplierController : Controller
    {
        ...
        public ViewResult Index(string txtCodeNName/*, string txtEmailNPhone*/)
        {
            ...
            if (string.IsNullOrEmpty(txtCodeNName) == false /*|| string.IsNullOrEmpty(txtEmailNPhone) == false*/)
            {
                ...
                q = q.Where(x => Erp.BackOffice.Helpers.Common.ChuyenThanhKhongDau(x.Name).Contains(txtCodeNName) || x.Code.ToLowerOrEmpty().Contains(txtCodeNName) || x.Phone.ToLowerOrEmpty().Contains(txtCodeNName) || x.Email.ToLowerOrEmpty().Contains(txtCodeNName));
            }
