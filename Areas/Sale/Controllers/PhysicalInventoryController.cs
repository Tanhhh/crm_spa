            ...
            if (ModelState.IsValid)
            {
                               ...
                               new System.TimeSpan(0, 30, 0)))
                {
                    try
                    {
                        ...
                        //ghi log 
                        Erp.BackOffice.Controllers.HomeController.WriteLog(PhysicalInventory.Id, PhysicalInventory.Code, "đã tạo phiếu kiểm kho", "PhysicalInventory/Detail/" + PhysicalInventory.Id, Helpers.Common.CurrentUser.BranchId.Value);
